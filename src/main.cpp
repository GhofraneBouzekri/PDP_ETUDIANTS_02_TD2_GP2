...
const char* wifi_ssid = "iPhone de Ryan";
...
const char* client_id = "TD02_GP02";
...
client.setCACert(ca_cert);
 ...
 if(mqtt_client.connect(client_id,mqtt_user,mqtt_pass)){
  mqtt_client.publish("TD02_GP02/temp",String (temp_measure).c_str());
  mqtt_client.publish("TD02_GP02/relhum",String (relative_humidity_measure).c_str());
 }
